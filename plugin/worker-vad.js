...
var vadFbank = null;
var vadCaches = [];
var vadModelBuf = null;
var totalVadMs = 0;
var vadCallCount = 0;
var running = false;
var fullAudio = new Float32Array(0);
var vadState = "SILENCE";
var speechFrames = 0;
var silenceFrames = 0;
var speechStart = -1;
var speechSamples = [];
var SIL_THRESH = 0.2;
var SPEECH_START_FRAMES = 20;
var SPEECH_END_FRAMES = 100;
var MAX_SPEECH_FRAMES = 600;
var PRE_ROLL_MS = 80;
var POST_ROLL_MS = 120;
var MIN_SPEECH_SAMPLES = 3200;
...
async function init(config) {
  ...
  vadSession = await Yd.create(config.vadModelBuffer, {
...
async function processChunk(chunk) {
  ...
  const feeds = {
    [vadSession.inputNames[0]]: new yt("float32", feat.slice(0, featLen * dim), [1, featLen, dim])
  };
  for (let i = 0; i < 4; i++) {
    feeds[vadSession.inputNames[i + 1]] = new yt("float32", vadCaches[i], [1, 128, 19, 1]);
  }
...
self.onmessage = async (e) => {
  ...
  try {
    ...
    post({ type: "error", message: `VAD: ${e2.message || String(e2)}` });
  }
};
/*!
